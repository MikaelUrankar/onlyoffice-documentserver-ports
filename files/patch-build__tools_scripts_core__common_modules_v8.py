...
+
+  if config.check_option("platform", "freebsd_64"):
+    base.cmd2("gn", ["gen", "out.gn/freebsd_64", "--args=\"is_debug=false v8_static_library=true is_component_build=false v8_use_snapshot=false is_clang=true use_sysroot=false treat_warnings_as_errors=false clang_use_chrome_plugins=false use_aura=true use_lld=true use_custom_libcxx=false v8_use_external_startup_data=false\""])
